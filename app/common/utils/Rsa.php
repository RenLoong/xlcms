...
class Rsa
{
    ...
    public static function encryptNumber(int $number)
    {
        ...
        // 加密数字
        $encrypted = openssl_encrypt($number, 'aes-256-cbc', self::KEY, 0, $iv);
     ...
     * @return int
     */
    public static function decryptNumber(string $encrypted)
    {
        // 解码加密后的数据
        ...
        // 解密数据
        $decrypted = openssl_decrypt($encryptedData, 'aes-256-cbc', self::KEY, 0, $iv);
